...
sem usar o framework de agentes que requer suporte a ferramentas.
"""
...
class SimpleSQLQuery:
    def __init__(self, db_path=None):
        """
        Inicializa o sistema de consulta SQL simples.
        ...
        self.llm = ChatOpenAI(
            model="deepseek/deepseek-v3-base:free",  # Usando o modelo deepseek
